...
#NutritionLabel h2{
    ...
    #NutritionLabel hr {
        ...
        #NutritionLabel hr:nth-of-type(4) {
            background: black;
            height: 11px;
            margin-top: -5px;
        }

        #NutritionLabel hr:nth-of-type(3) { 
            height: 1px;
            margin-top: -5px;
        }
...
#IngredientsDetailsTable div > div:first-of-type {
    width: 33%; 
    float: left;
}

#IngredientsDetailsTable div > div:nth-of-type(2) { 
    float: left;
    width: 33%;
}

#IngredientsDetailsTable div > div:last-of-type { 
    float: right;
    width: 33%;
}
...
#Nutrients  .floatLeft div  {
    background-color:yellow; 
} 

#Nutrients  .floatRight  div    {
    background-color:blueviolet; 
    width:100%;
}

#Nutrients div:nth-last-of-type(2),
#Nutrients div:last-of-type 
{
